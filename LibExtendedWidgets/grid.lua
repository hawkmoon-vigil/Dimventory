...
local function Layout(self)
  ...
  for i, row in ipairs(self.rows) do
	...
	--if self.rowBorder then
	--	rowWidth = rowWidth + self.rowBorder.width * 2
	--end
...
local function SetBorder(self, width, r, g, b, a)
  Library.LibExtendedWidgets.SetBorder(self, width, r, g, b, a)
end
...
local function SetRowBorder(self, width, r, g, b, a)
	self.rowborder = width
	self:SetBackgroundColor(r, g, b, a)
end

-- Constructor Function

function Library.LibExtendedWidgets.Grid(name, parent)
  ...
  widget.SetRowBorder = SetRowBorder
